...
module.exports = {
  up: async (queryInterface, Sequelize) => { 
    return Promise.all([
      ...
      queryInterface.renameColumn('Supplier', 'representative_name', 'representative'),
      queryInterface.renameColumn('Supplier', 'product_service', 'ProductAndService'),
  ...
  down: async (queryInterface, Sequelize) => {
    return Promise.all([
      ...
      queryInterface.renameColumn('Supplier', 'representative', 'representative_name'),
      queryInterface.renameColumn('Supplier', 'ProductAndService', 'product_service'),
      queryInterface.renameColumn('Supplier', 'Market', 'market'),
